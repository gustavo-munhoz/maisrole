...
/**
   ...
   * `prisma.eventState`: Exposes CRUD operations for the **EventState** model.
    ...
    * ```
    */
  get eventState(): Prisma.EventStateDelegate<GlobalReject>;
  ...
  /**
   * `prisma.hostAgenda`: Exposes CRUD operations for the **HostAgenda** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more HostAgenda
    * const hostAgenda = await prisma.hostAgenda.findMany()
    * ```
    */
  get hostAgenda(): Prisma.HostAgendaDelegate<GlobalReject>;
  ...
  /**
   * `prisma.hostType`: Exposes CRUD operations for the **HostType** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more HostTypes
    * const hostTypes = await prisma.hostType.findMany()
    * ```
    */
  get hostType(): Prisma.HostTypeDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  /**
   * Count Type EventStateCountOutputType
   */


  export type EventStateCountOutputType = {
    Event: number
  }

  export type EventStateCountOutputTypeSelect = {
    Event?: boolean
  }

  export type EventStateCountOutputTypeGetPayload<S extends boolean | null | undefined | EventStateCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? EventStateCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (EventStateCountOutputTypeArgs)
    ? EventStateCountOutputType 
    : S extends { select: any } & (EventStateCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof EventStateCountOutputType ? EventStateCountOutputType[P] : never
  } 
      : EventStateCountOutputType
  ...
  /**
   * EventStateCountOutputType without action
   */
  export type EventStateCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the EventStateCountOutputType
     */
    select?: EventStateCountOutputTypeSelect | null
  }
  ...
  export type WeekDayCountOutputTypeGetPayload<S extends boolean | null | undefined | WeekDayCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? WeekDayCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (WeekDayCountOutputTypeArgs)
    ? WeekDayCountOutputType 
    : S extends { select: any } & (WeekDayCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof WeekDayCountOutputType ? WeekDayCountOutputType[P] : never
  } 
      : WeekDayCountOutputType
   ...
   */
  export type WeekDayCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the WeekDayCountOutputType
     */
    select?: WeekDayCountOutputTypeSelect | null
  }
  ...
  /**
   * Count Type HostTypeCountOutputType
   */


  export type HostTypeCountOutputType = {
    host: number
  }

  export type HostTypeCountOutputTypeSelect = {
    host?: boolean
  }

  export type HostTypeCountOutputTypeGetPayload<S extends boolean | null | undefined | HostTypeCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? HostTypeCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (HostTypeCountOutputTypeArgs)
    ? HostTypeCountOutputType 
    : S extends { select: any } & (HostTypeCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof HostTypeCountOutputType ? HostTypeCountOutputType[P] : never
  } 
      : HostTypeCountOutputType
  ...
  /**
   * HostTypeCountOutputType without action
   */
  export type HostTypeCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the HostTypeCountOutputType
     */
    select?: HostTypeCountOutputTypeSelect | null
  }
  ...
  export type HostSelect = {
    ...
    events?: boolean | Host$eventsArgs
    agenda?: boolean | Host$agendaArgs
    HostType?: boolean | HostTypeArgs
    hostTypeId?: boolean
  ...
  export type HostGetPayload<S extends boolean | null | undefined | HostArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'agenda' ? Array < HostAgendaGetPayload<S['include'][P]>>  :
        P extends 'HostType' ? HostTypeGetPayload<S['include'][P]> | null :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'agenda' ? Array < HostAgendaGetPayload<S['select'][P]>>  :
        P extends 'HostType' ? HostTypeGetPayload<S['select'][P]> | null :
  ...
  export class Prisma__HostClient<T, Null = never> implements PrismaPromise<T> {
    ...
    events<T extends Host$eventsArgs= {}>(args?: Subset<T, Host$eventsArgs>): PrismaPromise<Array<EventGetPayload<T>>| Null>;

    agenda<T extends Host$agendaArgs= {}>(args?: Subset<T, Host$agendaArgs>): PrismaPromise<Array<HostAgendaGetPayload<T>>| Null>;

    HostType<T extends HostTypeArgs= {}>(args?: Subset<T, HostTypeArgs>): Prisma__HostTypeClient<HostTypeGetPayload<T> | Null>;
   ...
   * Host.agenda
   */
  export type Host$agendaArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: HostAgendaInclude | null
    where?: HostAgendaWhereInput
    orderBy?: Enumerable<HostAgendaOrderByWithRelationInput>
    cursor?: HostAgendaWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<HostAgendaScalarFieldEnum>
  }
  ...
  export type EventGetPayload<S extends boolean | null | undefined | EventArgs> =
    ...
    ? Event  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'host' ? HostGetPayload<S['include'][P]> :
        P extends 'state' ? EventStateGetPayload<S['include'][P]> :
        P extends 'eventType' ? EventTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (EventArgs | EventFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'host' ? HostGetPayload<S['select'][P]> :
        P extends 'state' ? EventStateGetPayload<S['select'][P]> :
  ...
  export class Prisma__EventClient<T, Null = never> implements PrismaPromise<T> {
    ...
    state<T extends EventStateArgs= {}>(args?: Subset<T, EventStateArgs>): Prisma__EventStateClient<EventStateGetPayload<T> | Null>;
  ...
  export type EventStateAggregateArgs = {
    /**
     ...
     */
    orderBy?: Enumerable<EventStateOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type EventStateGroupByArgs = {
    where?: EventStateWhereInput
    orderBy?: Enumerable<EventStateOrderByWithAggregationInput>
    by: EventStateScalarFieldEnum[]
  ...
  type GetEventStateGroupByPayload<T extends EventStateGroupByArgs> = PrismaPromise<
    Array<
      PickArray<EventStateGroupByOutputType, T['by']> &
        {
  ...
  export type EventStateSelect = {
    id?: boolean
    status?: boolean
    Event?: boolean | EventState$EventArgs
    _count?: boolean | EventStateCountOutputTypeArgs
  }


  export type EventStateInclude = {
    Event?: boolean | EventState$EventArgs
    _count?: boolean | EventStateCountOutputTypeArgs
  }

  export type EventStateGetPayload<S extends boolean | null | undefined | EventStateArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? EventState :
    S extends undefined ? never :
    S extends { include: any } & (EventStateArgs | EventStateFindManyArgs)
    ? EventState  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'Event' ? Array < EventGetPayload<S['include'][P]>>  :
        P extends '_count' ? EventStateCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (EventStateArgs | EventStateFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'Event' ? Array < EventGetPayload<S['select'][P]>>  :
        P extends '_count' ? EventStateCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof EventState ? EventState[P] : never
  } 
      : EventState


  type EventStateCountArgs = 
    Omit<EventStateFindManyArgs, 'select' | 'include'> & {
      select?: EventStateCountAggregateInputType | true
    }

  export interface EventStateDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends EventStateFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, EventStateFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'EventState'> extends True ? Prisma__EventStateClient<EventStateGetPayload<T>> : Prisma__EventStateClient<EventStateGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends EventStateFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, EventStateFindUniqueOrThrowArgs>
    ): Prisma__EventStateClient<EventStateGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends EventStateFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, EventStateFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'EventState'> extends True ? Prisma__EventStateClient<EventStateGetPayload<T>> : Prisma__EventStateClient<EventStateGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends EventStateFindFirstOrThrowArgs>(
      args?: SelectSubset<T, EventStateFindFirstOrThrowArgs>
    ): Prisma__EventStateClient<EventStateGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends EventStateFindManyArgs>(
      args?: SelectSubset<T, EventStateFindManyArgs>
    ): PrismaPromise<Array<EventStateGetPayload<T>>>
     ...
     * 
    **/
    create<T extends EventStateCreateArgs>(
      args: SelectSubset<T, EventStateCreateArgs>
    ): Prisma__EventStateClient<EventStateGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends EventStateCreateManyArgs>(
      args?: SelectSubset<T, EventStateCreateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends EventStateDeleteArgs>(
      args: SelectSubset<T, EventStateDeleteArgs>
    ): Prisma__EventStateClient<EventStateGetPayload<T>>
     ...
     * 
    **/
    update<T extends EventStateUpdateArgs>(
      args: SelectSubset<T, EventStateUpdateArgs>
    ): Prisma__EventStateClient<EventStateGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends EventStateDeleteManyArgs>(
      args?: SelectSubset<T, EventStateDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends EventStateUpdateManyArgs>(
      args: SelectSubset<T, EventStateUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends EventStateUpsertArgs>(
      args: SelectSubset<T, EventStateUpsertArgs>
    ): Prisma__EventStateClient<EventStateGetPayload<T>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends EventStateAggregateArgs>(args: Subset<T, EventStateAggregateArgs>): PrismaPromise<GetEventStateAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, EventStateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEventStateGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__EventStateClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    Event<T extends EventState$EventArgs= {}>(args?: Subset<T, EventState$EventArgs>): PrismaPromise<Array<EventGetPayload<T>>| Null>;
  ...
  /**
   * EventState base type for findUnique actions
   */
  export type EventStateFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: EventStateInclude | null
    /**
   ...
   */
  export interface EventStateFindUniqueArgs extends EventStateFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type EventStateFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
  ...
  /**
   * EventState base type for findFirst actions
   */
  export type EventStateFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
     ...
     */
    distinct?: Enumerable<EventStateScalarFieldEnum>
  }

  /**
   * EventState findFirst
   */
  export interface EventStateFindFirstArgs extends EventStateFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type EventStateFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
   ...
   * EventState findMany
   */
  export type EventStateFindManyArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
   ...
   * EventState create
   */
  export type EventStateCreateArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
   ...
   */
  export type EventStateCreateManyArgs = {
    /**
     * The data used to create many EventStates.
     */
    data: Enumerable<EventStateCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * EventState update
   */
  export type EventStateUpdateArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
   ...
   */
  export type EventStateUpdateManyArgs = {
    /**
   ...
   * EventState upsert
   */
  export type EventStateUpsertArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
   ...
   * EventState delete
   */
  export type EventStateDeleteArgs = {
    /**
     * Select specific fields to fetch from the EventState
     */
    select?: EventStateSelect | null
   ...
   */
  export type EventStateDeleteManyArgs = {
    /**
   ...
   * EventState.Event
   */
  export type EventState$EventArgs = {
    /**
     * Select specific fields to fetch from the Event
     */
    select?: EventSelect | null
  ...
  type GetWeekDayGroupByPayload<T extends WeekDayGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type WeekDaySelect = {
    id?: boolean
    day?: boolean
    Agenda?: boolean | WeekDay$AgendaArgs
  ...
  export interface WeekDayDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<WeekDayGetPayload<T>>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, WeekDayGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWeekDayGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__WeekDayClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    Agenda<T extends WeekDay$AgendaArgs= {}>(args?: Subset<T, WeekDay$AgendaArgs>): PrismaPromise<Array<HostAgendaGetPayload<T>>| Null>;
   ...
   * WeekDay.Agenda
   */
  export type WeekDay$AgendaArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
  ...
  export type AggregateHostAgenda = {
    _count: HostAgendaCountAggregateOutputType | null
    _avg: HostAgendaAvgAggregateOutputType | null
    _sum: HostAgendaSumAggregateOutputType | null
    _min: HostAgendaMinAggregateOutputType | null
    _max: HostAgendaMaxAggregateOutputType | null
  }

  export type HostAgendaAvgAggregateOutputType = {
    id: number | null
    dayId: number | null
    hostId: number | null
  }

  export type HostAgendaSumAggregateOutputType = {
    id: number | null
    dayId: number | null
    hostId: number | null
  }

  export type HostAgendaMinAggregateOutputType = {
    id: number | null
    dayId: number | null
    open: string | null
    hostId: number | null
  ...
  export type HostAgendaMaxAggregateOutputType = {
    id: number | null
    dayId: number | null
    open: string | null
    hostId: number | null
  ...
  export type HostAgendaCountAggregateOutputType = {
    id: number
    dayId: number
    open: number
    hostId: number
  ...
  export type HostAgendaAvgAggregateInputType = {
    id?: true
    dayId?: true
    hostId?: true
  }

  export type HostAgendaSumAggregateInputType = {
    id?: true
    dayId?: true
    hostId?: true
  }

  export type HostAgendaMinAggregateInputType = {
    id?: true
    dayId?: true
    open?: true
    hostId?: true
  ...
  export type HostAgendaMaxAggregateInputType = {
    id?: true
    dayId?: true
    open?: true
    hostId?: true
  ...
  export type HostAgendaCountAggregateInputType = {
    id?: true
    dayId?: true
    open?: true
    hostId?: true
  ...
  export type HostAgendaAggregateArgs = {
    /**
     * Filter which HostAgenda to aggregate.
     */
    where?: HostAgendaWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of HostAgenda to fetch.
     */
    orderBy?: Enumerable<HostAgendaOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` HostAgenda from the position of the cursor.
     */
    take?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Skip the first `n` HostAgenda.
     */
    skip?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned HostAgenda
    **/
    _count?: true | HostAgendaCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    _avg?: HostAgendaAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    _sum?: HostAgendaSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: HostAgendaMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: HostAgendaMaxAggregateInputType
  }

  export type GetHostAgendaAggregateType<T extends HostAgendaAggregateArgs> = {
        [P in keyof T & keyof AggregateHostAgenda]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateHostAgenda[P]>
      : GetScalarType<T[P], AggregateHostAgenda[P]>
  }
  ...
  export type HostAgendaGroupByArgs = {
    where?: HostAgendaWhereInput
    orderBy?: Enumerable<HostAgendaOrderByWithAggregationInput>
    by: HostAgendaScalarFieldEnum[]
    having?: HostAgendaScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: HostAgendaCountAggregateInputType | true
    _avg?: HostAgendaAvgAggregateInputType
    _sum?: HostAgendaSumAggregateInputType
    _min?: HostAgendaMinAggregateInputType
    _max?: HostAgendaMaxAggregateInputType
  ...
  export type HostAgendaGroupByOutputType = {
    id: number
    dayId: number
    open: string
    hostId: number
  ...
  type GetHostAgendaGroupByPayload<T extends HostAgendaGroupByArgs> = PrismaPromise<
    Array<
      PickArray<HostAgendaGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof HostAgendaGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], HostAgendaGroupByOutputType[P]>
            : GetScalarType<T[P], HostAgendaGroupByOutputType[P]>
        }
      >
    >
  ...
  export type HostAgendaInclude = {
    weekday?: boolean | WeekDayArgs
    host?: boolean | HostArgs
  }

  export type HostAgendaGetPayload<S extends boolean | null | undefined | HostAgendaArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? HostAgenda :
    S extends undefined ? never :
    S extends { include: any } & (HostAgendaArgs | HostAgendaFindManyArgs)
    ? HostAgenda  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'weekday' ? WeekDayGetPayload<S['include'][P]> :
        P extends 'host' ? HostGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (HostAgendaArgs | HostAgendaFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'weekday' ? WeekDayGetPayload<S['select'][P]> :
        P extends 'host' ? HostGetPayload<S['select'][P]> | null :  P extends keyof HostAgenda ? HostAgenda[P] : never
  } 
      : HostAgenda


  type HostAgendaCountArgs = 
    Omit<HostAgendaFindManyArgs, 'select' | 'include'> & {
      select?: HostAgendaCountAggregateInputType | true
    }

  export interface HostAgendaDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {

    /**
     * Find zero or one HostAgenda that matches the filter.
     * @param {HostAgendaFindUniqueArgs} args - Arguments to find a HostAgenda
     * @example
     * // Get one HostAgenda
     * const hostAgenda = await prisma.hostAgenda.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends HostAgendaFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, HostAgendaFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'HostAgenda'> extends True ? Prisma__HostAgendaClient<HostAgendaGetPayload<T>> : Prisma__HostAgendaClient<HostAgendaGetPayload<T> | null, null>

    /**
     * Find one HostAgenda that matches the filter or throw an error  with `error.code='P2025'` 
     *     if no matches were found.
     * @param {HostAgendaFindUniqueOrThrowArgs} args - Arguments to find a HostAgenda
     * @example
     * // Get one HostAgenda
     * const hostAgenda = await prisma.hostAgenda.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends HostAgendaFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, HostAgendaFindUniqueOrThrowArgs>
    ): Prisma__HostAgendaClient<HostAgendaGetPayload<T>>

    /**
     * Find the first HostAgenda that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaFindFirstArgs} args - Arguments to find a HostAgenda
     * @example
     * // Get one HostAgenda
     * const hostAgenda = await prisma.hostAgenda.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends HostAgendaFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, HostAgendaFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'HostAgenda'> extends True ? Prisma__HostAgendaClient<HostAgendaGetPayload<T>> : Prisma__HostAgendaClient<HostAgendaGetPayload<T> | null, null>

    /**
     * Find the first HostAgenda that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaFindFirstOrThrowArgs} args - Arguments to find a HostAgenda
     * @example
     * // Get one HostAgenda
     * const hostAgenda = await prisma.hostAgenda.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends HostAgendaFindFirstOrThrowArgs>(
      args?: SelectSubset<T, HostAgendaFindFirstOrThrowArgs>
    ): Prisma__HostAgendaClient<HostAgendaGetPayload<T>>

    /**
     * Find zero or more HostAgenda that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all HostAgenda
     * const hostAgenda = await prisma.hostAgenda.findMany()
     * 
     * // Get first 10 HostAgenda
     * const hostAgenda = await prisma.hostAgenda.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const hostAgendaWithIdOnly = await prisma.hostAgenda.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends HostAgendaFindManyArgs>(
      args?: SelectSubset<T, HostAgendaFindManyArgs>
    ): PrismaPromise<Array<HostAgendaGetPayload<T>>>

    /**
     * Create a HostAgenda.
     * @param {HostAgendaCreateArgs} args - Arguments to create a HostAgenda.
     * @example
     * // Create one HostAgenda
     * const HostAgenda = await prisma.hostAgenda.create({
     *   data: {
     *     // ... data to create a HostAgenda
     *   }
     * })
     * 
    **/
    create<T extends HostAgendaCreateArgs>(
      args: SelectSubset<T, HostAgendaCreateArgs>
    ): Prisma__HostAgendaClient<HostAgendaGetPayload<T>>

    /**
     * Create many HostAgenda.
     *     @param {HostAgendaCreateManyArgs} args - Arguments to create many HostAgenda.
     *     @example
     *     // Create many HostAgenda
     *     const hostAgenda = await prisma.hostAgenda.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends HostAgendaCreateManyArgs>(
      args?: SelectSubset<T, HostAgendaCreateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Delete a HostAgenda.
     * @param {HostAgendaDeleteArgs} args - Arguments to delete one HostAgenda.
     * @example
     * // Delete one HostAgenda
     * const HostAgenda = await prisma.hostAgenda.delete({
     *   where: {
     *     // ... filter to delete one HostAgenda
     *   }
     * })
     * 
    **/
    delete<T extends HostAgendaDeleteArgs>(
      args: SelectSubset<T, HostAgendaDeleteArgs>
    ): Prisma__HostAgendaClient<HostAgendaGetPayload<T>>

    /**
     * Update one HostAgenda.
     * @param {HostAgendaUpdateArgs} args - Arguments to update one HostAgenda.
     * @example
     * // Update one HostAgenda
     * const hostAgenda = await prisma.hostAgenda.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends HostAgendaUpdateArgs>(
      args: SelectSubset<T, HostAgendaUpdateArgs>
    ): Prisma__HostAgendaClient<HostAgendaGetPayload<T>>

    /**
     * Delete zero or more HostAgenda.
     * @param {HostAgendaDeleteManyArgs} args - Arguments to filter HostAgenda to delete.
     * @example
     * // Delete a few HostAgenda
     * const { count } = await prisma.hostAgenda.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends HostAgendaDeleteManyArgs>(
      args?: SelectSubset<T, HostAgendaDeleteManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Update zero or more HostAgenda.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many HostAgenda
     * const hostAgenda = await prisma.hostAgenda.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends HostAgendaUpdateManyArgs>(
      args: SelectSubset<T, HostAgendaUpdateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Create or update one HostAgenda.
     * @param {HostAgendaUpsertArgs} args - Arguments to update or create a HostAgenda.
     * @example
     * // Update or create a HostAgenda
     * const hostAgenda = await prisma.hostAgenda.upsert({
     *   create: {
     *     // ... data to create a HostAgenda
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the HostAgenda we want to update
     *   }
     * })
    **/
    upsert<T extends HostAgendaUpsertArgs>(
      args: SelectSubset<T, HostAgendaUpsertArgs>
    ): Prisma__HostAgendaClient<HostAgendaGetPayload<T>>

    /**
     * Count the number of HostAgenda.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaCountArgs} args - Arguments to filter HostAgenda to count.
     * @example
     * // Count the number of HostAgenda
     * const count = await prisma.hostAgenda.count({
     *   where: {
     *     // ... the filter for the HostAgenda we want to count
     *   }
     * })
    **/
    count<T extends HostAgendaCountArgs>(
      args?: Subset<T, HostAgendaCountArgs>,
    ): PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], HostAgendaCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a HostAgenda.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends HostAgendaAggregateArgs>(args: Subset<T, HostAgendaAggregateArgs>): PrismaPromise<GetHostAgendaAggregateType<T>>

    /**
     * Group by HostAgenda.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostAgendaGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends HostAgendaGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: HostAgendaGroupByArgs['orderBy'] }
        : { orderBy?: HostAgendaGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, HostAgendaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHostAgendaGroupByPayload<T> : PrismaPromise<InputErrors>

  }

  /**
   * The delegate class that acts as a "Promise-like" for HostAgenda.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__HostAgendaClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * HostAgenda base type for findUnique actions
   */
  export type HostAgendaFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
    ...
    include?: HostAgendaInclude | null
    /**
     * Filter, which HostAgenda to fetch.
     */
    where: HostAgendaWhereUniqueInput
  }

  /**
   * HostAgenda findUnique
   */
  export interface HostAgendaFindUniqueArgs extends HostAgendaFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * HostAgenda findUniqueOrThrow
   */
  export type HostAgendaFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
  ...
  /**
   * HostAgenda base type for findFirst actions
   */
  export type HostAgendaFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for HostAgenda.
     */
    cursor?: HostAgendaWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of HostAgenda.
     */
    distinct?: Enumerable<HostAgendaScalarFieldEnum>
  }

  /**
   * HostAgenda findFirst
   */
  export interface HostAgendaFindFirstArgs extends HostAgendaFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  /**
   * HostAgenda findFirstOrThrow
   */
  export type HostAgendaFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
   ...
   * HostAgenda findMany
   */
  export type HostAgendaFindManyArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing HostAgenda.
     */
    cursor?: HostAgendaWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   ...
   * HostAgenda create
   */
  export type HostAgendaCreateArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
    ...
    include?: HostAgendaInclude | null
    /**
     * The data needed to create a HostAgenda.
     */
    data: XOR<HostAgendaCreateInput, HostAgendaUncheckedCreateInput>
  }


  /**
   * HostAgenda createMany
   */
  export type HostAgendaCreateManyArgs = {
    /**
     * The data used to create many HostAgenda.
     */
    data: Enumerable<HostAgendaCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * HostAgenda update
   */
  export type HostAgendaUpdateArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
    ...
    include?: HostAgendaInclude | null
    /**
     * The data needed to update a HostAgenda.
     */
    data: XOR<HostAgendaUpdateInput, HostAgendaUncheckedUpdateInput>
    /**
     * Choose, which HostAgenda to update.
     */
    where: HostAgendaWhereUniqueInput
  }
  ...
  /**
   * HostAgenda updateMany
   */
  export type HostAgendaUpdateManyArgs = {
    /**
     * The data used to update HostAgenda.
     */
    data: XOR<HostAgendaUpdateManyMutationInput, HostAgendaUncheckedUpdateManyInput>
    /**
     * Filter which HostAgenda to update
     */
    where?: HostAgendaWhereInput
  }
   ...
   * HostAgenda upsert
   */
  export type HostAgendaUpsertArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
    ...
    include?: HostAgendaInclude | null
    /**
     * The filter to search for the HostAgenda to update in case it exists.
     */
    where: HostAgendaWhereUniqueInput
    /**
     * In case the HostAgenda found by the `where` argument doesn't exist, create a new HostAgenda with this data.
     */
    create: XOR<HostAgendaCreateInput, HostAgendaUncheckedCreateInput>
    /**
     * In case the HostAgenda was found with the provided `where` argument, update it with this data.
     */
    update: XOR<HostAgendaUpdateInput, HostAgendaUncheckedUpdateInput>
  }
   ...
   * HostAgenda delete
   */
  export type HostAgendaDeleteArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
    ...
    include?: HostAgendaInclude | null
    /**
     * Filter which HostAgenda to delete.
     */
    where: HostAgendaWhereUniqueInput
  }
  ...
  /**
   * HostAgenda deleteMany
   */
  export type HostAgendaDeleteManyArgs = {
    /**
     * Filter which HostAgenda to delete
     */
    where?: HostAgendaWhereInput
  ...
  /**
   * HostAgenda without action
   */
  export type HostAgendaArgs = {
    /**
     * Select specific fields to fetch from the HostAgenda
     */
    select?: HostAgendaSelect | null
  ...
  export type EventTypeSelect = {
    id?: boolean
    type?: boolean
    event?: boolean | EventType$eventArgs
  ...
  export interface EventTypeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<EventTypeGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__EventTypeClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    event<T extends EventType$eventArgs= {}>(args?: Subset<T, EventType$eventArgs>): PrismaPromise<Array<EventGetPayload<T>>| Null>;
   ...
   * EventType.event
   */
  export type EventType$eventArgs = {
    /**
     * Select specific fields to fetch from the Event
     */
    select?: EventSelect | null
  ...
  export type AggregateHostType = {
    _count: HostTypeCountAggregateOutputType | null
    _avg: HostTypeAvgAggregateOutputType | null
    _sum: HostTypeSumAggregateOutputType | null
    _min: HostTypeMinAggregateOutputType | null
    _max: HostTypeMaxAggregateOutputType | null
  }

  export type HostTypeAvgAggregateOutputType = {
    id: number | null
  }

  export type HostTypeSumAggregateOutputType = {
    id: number | null
  }

  export type HostTypeMinAggregateOutputType = {
    id: number | null
    type: string | null
  }

  export type HostTypeMaxAggregateOutputType = {
    id: number | null
    type: string | null
  }

  export type HostTypeCountAggregateOutputType = {
    id: number
    type: number
    _all: number
  }
  ...
  export type HostTypeAvgAggregateInputType = {
    id?: true
  }

  export type HostTypeSumAggregateInputType = {
    id?: true
  }

  export type HostTypeMinAggregateInputType = {
    id?: true
    type?: true
  }

  export type HostTypeMaxAggregateInputType = {
    id?: true
    type?: true
  }

  export type HostTypeCountAggregateInputType = {
    id?: true
    type?: true
    _all?: true
  }

  export type HostTypeAggregateArgs = {
    /**
     * Filter which HostType to aggregate.
     */
    where?: HostTypeWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of HostTypes to fetch.
     */
    orderBy?: Enumerable<HostTypeOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
     */
    cursor?: HostTypeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` HostTypes from the position of the cursor.
     */
    take?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Skip the first `n` HostTypes.
     */
    skip?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned HostTypes
    **/
    _count?: true | HostTypeCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    _avg?: HostTypeAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    _sum?: HostTypeSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: HostTypeMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: HostTypeMaxAggregateInputType
  }

  export type GetHostTypeAggregateType<T extends HostTypeAggregateArgs> = {
        [P in keyof T & keyof AggregateHostType]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateHostType[P]>
      : GetScalarType<T[P], AggregateHostType[P]>
  }
  ...
  export type HostTypeGroupByArgs = {
    where?: HostTypeWhereInput
    orderBy?: Enumerable<HostTypeOrderByWithAggregationInput>
    by: HostTypeScalarFieldEnum[]
    having?: HostTypeScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: HostTypeCountAggregateInputType | true
    _avg?: HostTypeAvgAggregateInputType
    _sum?: HostTypeSumAggregateInputType
    _min?: HostTypeMinAggregateInputType
    _max?: HostTypeMaxAggregateInputType
  ...
  export type HostTypeGroupByOutputType = {
    id: number
    type: string
    _count: HostTypeCountAggregateOutputType | null
    _avg: HostTypeAvgAggregateOutputType | null
  ...
  type GetHostTypeGroupByPayload<T extends HostTypeGroupByArgs> = PrismaPromise<
    Array<
      PickArray<HostTypeGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof HostTypeGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], HostTypeGroupByOutputType[P]>
            : GetScalarType<T[P], HostTypeGroupByOutputType[P]>
        }
      >
    >
  ...
  export type HostTypeSelect = {
    id?: boolean
    type?: boolean
    host?: boolean | HostType$hostArgs
    _count?: boolean | HostTypeCountOutputTypeArgs
  }


  export type HostTypeInclude = {
    host?: boolean | HostType$hostArgs
    _count?: boolean | HostTypeCountOutputTypeArgs
  }

  export type HostTypeGetPayload<S extends boolean | null | undefined | HostTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? HostType :
    S extends undefined ? never :
    S extends { include: any } & (HostTypeArgs | HostTypeFindManyArgs)
    ? HostType  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'host' ? Array < HostGetPayload<S['include'][P]>>  :
        P extends '_count' ? HostTypeCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (HostTypeArgs | HostTypeFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'host' ? Array < HostGetPayload<S['select'][P]>>  :
        P extends '_count' ? HostTypeCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof HostType ? HostType[P] : never
  } 
      : HostType


  type HostTypeCountArgs = 
    Omit<HostTypeFindManyArgs, 'select' | 'include'> & {
      select?: HostTypeCountAggregateInputType | true
    }

  export interface HostTypeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {

    /**
     * Find zero or one HostType that matches the filter.
     * @param {HostTypeFindUniqueArgs} args - Arguments to find a HostType
     * @example
     * // Get one HostType
     * const hostType = await prisma.hostType.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends HostTypeFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, HostTypeFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'HostType'> extends True ? Prisma__HostTypeClient<HostTypeGetPayload<T>> : Prisma__HostTypeClient<HostTypeGetPayload<T> | null, null>

    /**
     * Find one HostType that matches the filter or throw an error  with `error.code='P2025'` 
     *     if no matches were found.
     * @param {HostTypeFindUniqueOrThrowArgs} args - Arguments to find a HostType
     * @example
     * // Get one HostType
     * const hostType = await prisma.hostType.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends HostTypeFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, HostTypeFindUniqueOrThrowArgs>
    ): Prisma__HostTypeClient<HostTypeGetPayload<T>>

    /**
     * Find the first HostType that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeFindFirstArgs} args - Arguments to find a HostType
     * @example
     * // Get one HostType
     * const hostType = await prisma.hostType.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends HostTypeFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, HostTypeFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'HostType'> extends True ? Prisma__HostTypeClient<HostTypeGetPayload<T>> : Prisma__HostTypeClient<HostTypeGetPayload<T> | null, null>

    /**
     * Find the first HostType that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeFindFirstOrThrowArgs} args - Arguments to find a HostType
     * @example
     * // Get one HostType
     * const hostType = await prisma.hostType.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends HostTypeFindFirstOrThrowArgs>(
      args?: SelectSubset<T, HostTypeFindFirstOrThrowArgs>
    ): Prisma__HostTypeClient<HostTypeGetPayload<T>>

    /**
     * Find zero or more HostTypes that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all HostTypes
     * const hostTypes = await prisma.hostType.findMany()
     * 
     * // Get first 10 HostTypes
     * const hostTypes = await prisma.hostType.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const hostTypeWithIdOnly = await prisma.hostType.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends HostTypeFindManyArgs>(
      args?: SelectSubset<T, HostTypeFindManyArgs>
    ): PrismaPromise<Array<HostTypeGetPayload<T>>>

    /**
     * Create a HostType.
     * @param {HostTypeCreateArgs} args - Arguments to create a HostType.
     * @example
     * // Create one HostType
     * const HostType = await prisma.hostType.create({
     *   data: {
     *     // ... data to create a HostType
     *   }
     * })
     * 
    **/
    create<T extends HostTypeCreateArgs>(
      args: SelectSubset<T, HostTypeCreateArgs>
    ): Prisma__HostTypeClient<HostTypeGetPayload<T>>

    /**
     * Create many HostTypes.
     *     @param {HostTypeCreateManyArgs} args - Arguments to create many HostTypes.
     *     @example
     *     // Create many HostTypes
     *     const hostType = await prisma.hostType.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends HostTypeCreateManyArgs>(
      args?: SelectSubset<T, HostTypeCreateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Delete a HostType.
     * @param {HostTypeDeleteArgs} args - Arguments to delete one HostType.
     * @example
     * // Delete one HostType
     * const HostType = await prisma.hostType.delete({
     *   where: {
     *     // ... filter to delete one HostType
     *   }
     * })
     * 
    **/
    delete<T extends HostTypeDeleteArgs>(
      args: SelectSubset<T, HostTypeDeleteArgs>
    ): Prisma__HostTypeClient<HostTypeGetPayload<T>>

    /**
     * Update one HostType.
     * @param {HostTypeUpdateArgs} args - Arguments to update one HostType.
     * @example
     * // Update one HostType
     * const hostType = await prisma.hostType.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends HostTypeUpdateArgs>(
      args: SelectSubset<T, HostTypeUpdateArgs>
    ): Prisma__HostTypeClient<HostTypeGetPayload<T>>

    /**
     * Delete zero or more HostTypes.
     * @param {HostTypeDeleteManyArgs} args - Arguments to filter HostTypes to delete.
     * @example
     * // Delete a few HostTypes
     * const { count } = await prisma.hostType.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends HostTypeDeleteManyArgs>(
      args?: SelectSubset<T, HostTypeDeleteManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Update zero or more HostTypes.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many HostTypes
     * const hostType = await prisma.hostType.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends HostTypeUpdateManyArgs>(
      args: SelectSubset<T, HostTypeUpdateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Create or update one HostType.
     * @param {HostTypeUpsertArgs} args - Arguments to update or create a HostType.
     * @example
     * // Update or create a HostType
     * const hostType = await prisma.hostType.upsert({
     *   create: {
     *     // ... data to create a HostType
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the HostType we want to update
     *   }
     * })
    **/
    upsert<T extends HostTypeUpsertArgs>(
      args: SelectSubset<T, HostTypeUpsertArgs>
    ): Prisma__HostTypeClient<HostTypeGetPayload<T>>

    /**
     * Count the number of HostTypes.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeCountArgs} args - Arguments to filter HostTypes to count.
     * @example
     * // Count the number of HostTypes
     * const count = await prisma.hostType.count({
     *   where: {
     *     // ... the filter for the HostTypes we want to count
     *   }
     * })
    **/
    count<T extends HostTypeCountArgs>(
      args?: Subset<T, HostTypeCountArgs>,
    ): PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], HostTypeCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a HostType.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends HostTypeAggregateArgs>(args: Subset<T, HostTypeAggregateArgs>): PrismaPromise<GetHostTypeAggregateType<T>>

    /**
     * Group by HostType.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {HostTypeGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends HostTypeGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: HostTypeGroupByArgs['orderBy'] }
        : { orderBy?: HostTypeGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, HostTypeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHostTypeGroupByPayload<T> : PrismaPromise<InputErrors>

  }

  /**
   * The delegate class that acts as a "Promise-like" for HostType.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__HostTypeClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    host<T extends HostType$hostArgs= {}>(args?: Subset<T, HostType$hostArgs>): PrismaPromise<Array<HostGetPayload<T>>| Null>;
  ...
  /**
   * HostType base type for findUnique actions
   */
  export type HostTypeFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: HostTypeInclude | null
    /**
     * Filter, which HostType to fetch.
     */
    where: HostTypeWhereUniqueInput
  }

  /**
   * HostType findUnique
   */
  export interface HostTypeFindUniqueArgs extends HostTypeFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * HostType findUniqueOrThrow
   */
  export type HostTypeFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
  ...
  /**
   * HostType base type for findFirst actions
   */
  export type HostTypeFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for HostTypes.
     */
    cursor?: HostTypeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of HostTypes.
     */
    distinct?: Enumerable<HostTypeScalarFieldEnum>
  }

  /**
   * HostType findFirst
   */
  export interface HostTypeFindFirstArgs extends HostTypeFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  /**
   * HostType findFirstOrThrow
   */
  export type HostTypeFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
   ...
   * HostType findMany
   */
  export type HostTypeFindManyArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
    ...
    include?: HostTypeInclude | null
    /**
     * Filter, which HostTypes to fetch.
     */
    where?: HostTypeWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing HostTypes.
     */
    cursor?: HostTypeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   ...
   * HostType create
   */
  export type HostTypeCreateArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
    ...
    include?: HostTypeInclude | null
    /**
     * The data needed to create a HostType.
     */
    data: XOR<HostTypeCreateInput, HostTypeUncheckedCreateInput>
  }
   ...
   * HostType createMany
   */
  export type HostTypeCreateManyArgs = {
    /**
     * The data used to create many HostTypes.
     */
    data: Enumerable<HostTypeCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * HostType update
   */
  export type HostTypeUpdateArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
    ...
    include?: HostTypeInclude | null
    /**
     * The data needed to update a HostType.
     */
    data: XOR<HostTypeUpdateInput, HostTypeUncheckedUpdateInput>
    /**
     * Choose, which HostType to update.
     */
    where: HostTypeWhereUniqueInput
  }
   ...
   * HostType updateMany
   */
  export type HostTypeUpdateManyArgs = {
    /**
     * The data used to update HostTypes.
     */
    data: XOR<HostTypeUpdateManyMutationInput, HostTypeUncheckedUpdateManyInput>
    /**
     * Filter which HostTypes to update
     */
    where?: HostTypeWhereInput
  }
   ...
   * HostType upsert
   */
  export type HostTypeUpsertArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
    ...
    include?: HostTypeInclude | null
    /**
     * The filter to search for the HostType to update in case it exists.
     */
    where: HostTypeWhereUniqueInput
    /**
     * In case the HostType found by the `where` argument doesn't exist, create a new HostType with this data.
     */
    create: XOR<HostTypeCreateInput, HostTypeUncheckedCreateInput>
    /**
     * In case the HostType was found with the provided `where` argument, update it with this data.
     */
    update: XOR<HostTypeUpdateInput, HostTypeUncheckedUpdateInput>
  }
   ...
   * HostType delete
   */
  export type HostTypeDeleteArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
    ...
    include?: HostTypeInclude | null
    /**
     * Filter which HostType to delete.
     */
    where: HostTypeWhereUniqueInput
  }
   ...
   * HostType deleteMany
   */
  export type HostTypeDeleteManyArgs = {
    /**
     * Filter which HostTypes to delete
     */
    where?: HostTypeWhereInput
  }
  ...
  /**
   * HostType without action
   */
  export type HostTypeArgs = {
    /**
     * Select specific fields to fetch from the HostType
     */
    select?: HostTypeSelect | null
  ...
  export const HostAgendaScalarFieldEnum: {
    id: 'id',
    dayId: 'dayId',
    open: 'open',
    hostId: 'hostId'
  ...
  export type HostAgendaScalarFieldEnum = (typeof HostAgendaScalarFieldEnum)[keyof typeof HostAgendaScalarFieldEnum]
  ...
  export const HostTypeScalarFieldEnum: {
    id: 'id',
    type: 'type'
  };

  export type HostTypeScalarFieldEnum = (typeof HostTypeScalarFieldEnum)[keyof typeof HostTypeScalarFieldEnum]
  ...
  export type HostWhereInput = {
    ...
    agenda?: HostAgendaListRelationFilter
    HostType?: XOR<HostTypeRelationFilter, HostTypeWhereInput> | null
    hostTypeId?: IntNullableFilter | number | null
  }
  ...
  export type HostOrderByWithRelationInput = {
    ...
    agenda?: HostAgendaOrderByRelationAggregateInput
    HostType?: HostTypeOrderByWithRelationInput
    hostTypeId?: SortOrder
  }
  ...
  export type HostScalarWhereWithAggregatesInput = {
    ...
    password?: StringWithAggregatesFilter | string
    hostTypeId?: IntNullableWithAggregatesFilter | number | null
  }
  ...
  export type EventWhereInput = {
    ...
    state?: XOR<EventStateRelationFilter, EventStateWhereInput>
  ...
  export type EventOrderByWithRelationInput = {
    ...
    price?: SortOrder
    brief?: SortOrder
    state?: EventStateOrderByWithRelationInput
    stateId?: SortOrder
  ...
  export type EventWhereUniqueInput = {
    id?: number
    id_hostId?: EventIdHostIdCompoundUniqueInput
  }
  ...
  export type EventStateWhereInput = {
    AND?: Enumerable<EventStateWhereInput>
    OR?: Enumerable<EventStateWhereInput>
    NOT?: Enumerable<EventStateWhereInput>
    id?: IntFilter | number
  ...
  export type EventStateWhereUniqueInput = {
    id?: number
  }
  ...
  export type EventStateScalarWhereWithAggregatesInput = {
    AND?: Enumerable<EventStateScalarWhereWithAggregatesInput>
    OR?: Enumerable<EventStateScalarWhereWithAggregatesInput>
    NOT?: Enumerable<EventStateScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
  ...
  export type HostAgendaWhereInput = {
    AND?: Enumerable<HostAgendaWhereInput>
    OR?: Enumerable<HostAgendaWhereInput>
    NOT?: Enumerable<HostAgendaWhereInput>
    id?: IntFilter | number
    weekday?: XOR<WeekDayRelationFilter, WeekDayWhereInput>
    dayId?: IntFilter | number
    open?: StringFilter | string
    host?: XOR<HostRelationFilter, HostWhereInput> | null
    hostId?: IntFilter | number
  }

  export type HostAgendaOrderByWithRelationInput = {
    id?: SortOrder
  ...
  export type HostAgendaWhereUniqueInput = {
    id_dayId_hostId?: HostAgendaIdDayIdHostIdCompoundUniqueInput
  }

  export type HostAgendaOrderByWithAggregationInput = {
    id?: SortOrder
    dayId?: SortOrder
    open?: SortOrder
    hostId?: SortOrder
    _count?: HostAgendaCountOrderByAggregateInput
    _avg?: HostAgendaAvgOrderByAggregateInput
    _max?: HostAgendaMaxOrderByAggregateInput
    _min?: HostAgendaMinOrderByAggregateInput
    _sum?: HostAgendaSumOrderByAggregateInput
  }

  export type HostAgendaScalarWhereWithAggregatesInput = {
    AND?: Enumerable<HostAgendaScalarWhereWithAggregatesInput>
    OR?: Enumerable<HostAgendaScalarWhereWithAggregatesInput>
    NOT?: Enumerable<HostAgendaScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    dayId?: IntWithAggregatesFilter | number
    open?: StringWithAggregatesFilter | string
    hostId?: IntWithAggregatesFilter | number
  }
  ...
  export type HostTypeWhereInput = {
    AND?: Enumerable<HostTypeWhereInput>
    OR?: Enumerable<HostTypeWhereInput>
    NOT?: Enumerable<HostTypeWhereInput>
    id?: IntFilter | number
    type?: StringFilter | string
    host?: HostListRelationFilter
  }

  export type HostTypeOrderByWithRelationInput = {
    id?: SortOrder
    type?: SortOrder
    host?: HostOrderByRelationAggregateInput
  }

  export type HostTypeWhereUniqueInput = {
    id?: number
  }

  export type HostTypeOrderByWithAggregationInput = {
    id?: SortOrder
    type?: SortOrder
    _count?: HostTypeCountOrderByAggregateInput
    _avg?: HostTypeAvgOrderByAggregateInput
    _max?: HostTypeMaxOrderByAggregateInput
    _min?: HostTypeMinOrderByAggregateInput
    _sum?: HostTypeSumOrderByAggregateInput
  }

  export type HostTypeScalarWhereWithAggregatesInput = {
    AND?: Enumerable<HostTypeScalarWhereWithAggregatesInput>
    OR?: Enumerable<HostTypeScalarWhereWithAggregatesInput>
    NOT?: Enumerable<HostTypeScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    type?: StringWithAggregatesFilter | string
  }
  ...
  export type HostCreateInput = {
    ...
    agenda?: HostAgendaCreateNestedManyWithoutHostInput
    HostType?: HostTypeCreateNestedOneWithoutHostInput
  }
  ...
  export type HostUncheckedCreateInput = {
    ...
    agenda?: HostAgendaUncheckedCreateNestedManyWithoutHostInput
    hostTypeId?: number | null
  }
  ...
  export type HostUpdateInput = {
    ...
    agenda?: HostAgendaUpdateManyWithoutHostNestedInput
    HostType?: HostTypeUpdateOneWithoutHostNestedInput
  }
  ...
  export type HostUncheckedUpdateInput = {
    ...
    agenda?: HostAgendaUncheckedUpdateManyWithoutHostNestedInput
    hostTypeId?: NullableIntFieldUpdateOperationsInput | number | null
  }
  ...
  export type EventCreateInput = {
    ...
    price: number
    brief: string
    state: EventStateCreateNestedOneWithoutEventInput
  ...
  export type EventUpdateInput = {
    ...
    state?: EventStateUpdateOneRequiredWithoutEventNestedInput
  ...
  export type EventStateCreateInput = {
    id: number
    status: string
    Event?: EventCreateNestedManyWithoutStateInput
  }

  export type EventStateUncheckedCreateInput = {
    id: number
    status: string
    Event?: EventUncheckedCreateNestedManyWithoutStateInput
  }

  export type EventStateUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    status?: StringFieldUpdateOperationsInput | string
    Event?: EventUpdateManyWithoutStateNestedInput
  }

  export type EventStateUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    status?: StringFieldUpdateOperationsInput | string
    Event?: EventUncheckedUpdateManyWithoutStateNestedInput
  }
  ...
  export type WeekDayCreateInput = {
    id: number
    day: string
    Agenda?: HostAgendaCreateNestedManyWithoutWeekdayInput
  }

  export type WeekDayUncheckedCreateInput = {
    id: number
    day: string
    Agenda?: HostAgendaUncheckedCreateNestedManyWithoutWeekdayInput
  }

  export type WeekDayUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    day?: StringFieldUpdateOperationsInput | string
    Agenda?: HostAgendaUpdateManyWithoutWeekdayNestedInput
  }

  export type WeekDayUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    day?: StringFieldUpdateOperationsInput | string
    Agenda?: HostAgendaUncheckedUpdateManyWithoutWeekdayNestedInput
  }
  ...
  export type HostAgendaCreateInput = {
    id?: number
    weekday: WeekDayCreateNestedOneWithoutAgendaInput
    open: string
    host?: HostCreateNestedOneWithoutAgendaInput
  }

  export type HostAgendaUncheckedCreateInput = {
    id?: number
    dayId: number
    open: string
    hostId: number
  ...
  export type HostAgendaUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    weekday?: WeekDayUpdateOneRequiredWithoutAgendaNestedInput
    open?: StringFieldUpdateOperationsInput | string
    host?: HostUpdateOneWithoutAgendaNestedInput
  }

  export type HostAgendaUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
  ...
  export type HostAgendaCreateManyInput = {
    id?: number
    dayId: number
    open: string
    hostId: number
  ...
  export type HostAgendaUpdateManyMutationInput = {
    id?: IntFieldUpdateOperationsInput | number
    open?: StringFieldUpdateOperationsInput | string
  }

  export type HostAgendaUncheckedUpdateManyInput = {
    id?: IntFieldUpdateOperationsInput | number
    dayId?: IntFieldUpdateOperationsInput | number
    open?: StringFieldUpdateOperationsInput | string
    hostId?: IntFieldUpdateOperationsInput | number
  ...
  export type HostTypeCreateInput = {
    type: string
    host?: HostCreateNestedManyWithoutHostTypeInput
  }

  export type HostTypeUncheckedCreateInput = {
    id?: number
    type: string
    host?: HostUncheckedCreateNestedManyWithoutHostTypeInput
  }

  export type HostTypeUpdateInput = {
    type?: StringFieldUpdateOperationsInput | string
    host?: HostUpdateManyWithoutHostTypeNestedInput
  }

  export type HostTypeUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    type?: StringFieldUpdateOperationsInput | string
    host?: HostUncheckedUpdateManyWithoutHostTypeNestedInput
  }

  export type HostTypeCreateManyInput = {
    id?: number
    type: string
  }

  export type HostTypeUpdateManyMutationInput = {
    type?: StringFieldUpdateOperationsInput | string
  }

  export type HostTypeUncheckedUpdateManyInput = {
    id?: IntFieldUpdateOperationsInput | number
    type?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type HostAgendaListRelationFilter = {
    every?: HostAgendaWhereInput
    some?: HostAgendaWhereInput
    none?: HostAgendaWhereInput
  }

  export type HostTypeRelationFilter = {
    is?: HostTypeWhereInput | null
    isNot?: HostTypeWhereInput | null
  }
  ...
  export type HostAgendaOrderByRelationAggregateInput = {
    _count?: SortOrder
  }
  ...
  export type EventStateRelationFilter = {
    is?: EventStateWhereInput
    isNot?: EventStateWhereInput
  }
  ...
  export type EventIdHostIdCompoundUniqueInput = {
    id: number
    hostId: number
  }
  ...
  export type HostAgendaIdDayIdHostIdCompoundUniqueInput = {
    id: number
    dayId: number
    hostId: number
  }

  export type HostAgendaCountOrderByAggregateInput = {
    id?: SortOrder
    dayId?: SortOrder
    open?: SortOrder
    hostId?: SortOrder
  ...
  export type HostAgendaAvgOrderByAggregateInput = {
    id?: SortOrder
    dayId?: SortOrder
    hostId?: SortOrder
  }

  export type HostAgendaMaxOrderByAggregateInput = {
    id?: SortOrder
    dayId?: SortOrder
    open?: SortOrder
    hostId?: SortOrder
  ...
  export type HostAgendaMinOrderByAggregateInput = {
    id?: SortOrder
    dayId?: SortOrder
    open?: SortOrder
    hostId?: SortOrder
  ...
  export type HostAgendaSumOrderByAggregateInput = {
    id?: SortOrder
    dayId?: SortOrder
    hostId?: SortOrder
  }
  ...
  export type HostTypeCountOrderByAggregateInput = {
    id?: SortOrder
    type?: SortOrder
  }

  export type HostTypeAvgOrderByAggregateInput = {
    id?: SortOrder
  }

  export type HostTypeMaxOrderByAggregateInput = {
    id?: SortOrder
    type?: SortOrder
  }

  export type HostTypeMinOrderByAggregateInput = {
    id?: SortOrder
    type?: SortOrder
  }

  export type HostTypeSumOrderByAggregateInput = {
    id?: SortOrder
  }
  ...
  export type HostAgendaCreateNestedManyWithoutHostInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutHostInput>, Enumerable<HostAgendaUncheckedCreateWithoutHostInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutHostInput>
    createMany?: HostAgendaCreateManyHostInputEnvelope
    connect?: Enumerable<HostAgendaWhereUniqueInput>
  }

  export type HostTypeCreateNestedOneWithoutHostInput = {
    create?: XOR<HostTypeCreateWithoutHostInput, HostTypeUncheckedCreateWithoutHostInput>
    connectOrCreate?: HostTypeCreateOrConnectWithoutHostInput
    connect?: HostTypeWhereUniqueInput
  }
  ...
  export type HostAgendaUncheckedCreateNestedManyWithoutHostInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutHostInput>, Enumerable<HostAgendaUncheckedCreateWithoutHostInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutHostInput>
    createMany?: HostAgendaCreateManyHostInputEnvelope
    connect?: Enumerable<HostAgendaWhereUniqueInput>
  ...
  export type HostAgendaUpdateManyWithoutHostNestedInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutHostInput>, Enumerable<HostAgendaUncheckedCreateWithoutHostInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutHostInput>
    upsert?: Enumerable<HostAgendaUpsertWithWhereUniqueWithoutHostInput>
    createMany?: HostAgendaCreateManyHostInputEnvelope
    set?: Enumerable<HostAgendaWhereUniqueInput>
    disconnect?: Enumerable<HostAgendaWhereUniqueInput>
    delete?: Enumerable<HostAgendaWhereUniqueInput>
    connect?: Enumerable<HostAgendaWhereUniqueInput>
    update?: Enumerable<HostAgendaUpdateWithWhereUniqueWithoutHostInput>
    updateMany?: Enumerable<HostAgendaUpdateManyWithWhereWithoutHostInput>
    deleteMany?: Enumerable<HostAgendaScalarWhereInput>
  }

  export type HostTypeUpdateOneWithoutHostNestedInput = {
    create?: XOR<HostTypeCreateWithoutHostInput, HostTypeUncheckedCreateWithoutHostInput>
    connectOrCreate?: HostTypeCreateOrConnectWithoutHostInput
    upsert?: HostTypeUpsertWithoutHostInput
    disconnect?: boolean
    delete?: boolean
    connect?: HostTypeWhereUniqueInput
    update?: XOR<HostTypeUpdateWithoutHostInput, HostTypeUncheckedUpdateWithoutHostInput>
  }
  ...
  export type HostAgendaUncheckedUpdateManyWithoutHostNestedInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutHostInput>, Enumerable<HostAgendaUncheckedCreateWithoutHostInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutHostInput>
    upsert?: Enumerable<HostAgendaUpsertWithWhereUniqueWithoutHostInput>
    createMany?: HostAgendaCreateManyHostInputEnvelope
  ...
  export type EventStateCreateNestedOneWithoutEventInput = {
    create?: XOR<EventStateCreateWithoutEventInput, EventStateUncheckedCreateWithoutEventInput>
    connectOrCreate?: EventStateCreateOrConnectWithoutEventInput
    connect?: EventStateWhereUniqueInput
  }
  ...
  export type EventStateUpdateOneRequiredWithoutEventNestedInput = {
    create?: XOR<EventStateCreateWithoutEventInput, EventStateUncheckedCreateWithoutEventInput>
    connectOrCreate?: EventStateCreateOrConnectWithoutEventInput
    upsert?: EventStateUpsertWithoutEventInput
    connect?: EventStateWhereUniqueInput
    update?: XOR<EventStateUpdateWithoutEventInput, EventStateUncheckedUpdateWithoutEventInput>
  }
  ...
  export type EventCreateNestedManyWithoutStateInput = {
    create?: XOR<Enumerable<EventCreateWithoutStateInput>, Enumerable<EventUncheckedCreateWithoutStateInput>>
    connectOrCreate?: Enumerable<EventCreateOrConnectWithoutStateInput>
    createMany?: EventCreateManyStateInputEnvelope
    connect?: Enumerable<EventWhereUniqueInput>
  }
  ...
  export type EventUpdateManyWithoutStateNestedInput = {
    create?: XOR<Enumerable<EventCreateWithoutStateInput>, Enumerable<EventUncheckedCreateWithoutStateInput>>
    connectOrCreate?: Enumerable<EventCreateOrConnectWithoutStateInput>
    upsert?: Enumerable<EventUpsertWithWhereUniqueWithoutStateInput>
    createMany?: EventCreateManyStateInputEnvelope
    set?: Enumerable<EventWhereUniqueInput>
    disconnect?: Enumerable<EventWhereUniqueInput>
    delete?: Enumerable<EventWhereUniqueInput>
    connect?: Enumerable<EventWhereUniqueInput>
    update?: Enumerable<EventUpdateWithWhereUniqueWithoutStateInput>
    updateMany?: Enumerable<EventUpdateManyWithWhereWithoutStateInput>
    deleteMany?: Enumerable<EventScalarWhereInput>
  }
  ...
  export type HostAgendaCreateNestedManyWithoutWeekdayInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutWeekdayInput>, Enumerable<HostAgendaUncheckedCreateWithoutWeekdayInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutWeekdayInput>
    createMany?: HostAgendaCreateManyWeekdayInputEnvelope
    connect?: Enumerable<HostAgendaWhereUniqueInput>
  }

  export type HostAgendaUncheckedCreateNestedManyWithoutWeekdayInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutWeekdayInput>, Enumerable<HostAgendaUncheckedCreateWithoutWeekdayInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutWeekdayInput>
    createMany?: HostAgendaCreateManyWeekdayInputEnvelope
    connect?: Enumerable<HostAgendaWhereUniqueInput>
  ...
  export type HostAgendaUpdateManyWithoutWeekdayNestedInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutWeekdayInput>, Enumerable<HostAgendaUncheckedCreateWithoutWeekdayInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutWeekdayInput>
    upsert?: Enumerable<HostAgendaUpsertWithWhereUniqueWithoutWeekdayInput>
    createMany?: HostAgendaCreateManyWeekdayInputEnvelope
    set?: Enumerable<HostAgendaWhereUniqueInput>
    disconnect?: Enumerable<HostAgendaWhereUniqueInput>
    delete?: Enumerable<HostAgendaWhereUniqueInput>
    connect?: Enumerable<HostAgendaWhereUniqueInput>
    update?: Enumerable<HostAgendaUpdateWithWhereUniqueWithoutWeekdayInput>
    updateMany?: Enumerable<HostAgendaUpdateManyWithWhereWithoutWeekdayInput>
    deleteMany?: Enumerable<HostAgendaScalarWhereInput>
  }

  export type HostAgendaUncheckedUpdateManyWithoutWeekdayNestedInput = {
    create?: XOR<Enumerable<HostAgendaCreateWithoutWeekdayInput>, Enumerable<HostAgendaUncheckedCreateWithoutWeekdayInput>>
    connectOrCreate?: Enumerable<HostAgendaCreateOrConnectWithoutWeekdayInput>
    upsert?: Enumerable<HostAgendaUpsertWithWhereUniqueWithoutWeekdayInput>
    createMany?: HostAgendaCreateManyWeekdayInputEnvelope
  ...
  export type WeekDayCreateNestedOneWithoutAgendaInput = {
    create?: XOR<WeekDayCreateWithoutAgendaInput, WeekDayUncheckedCreateWithoutAgendaInput>
    connectOrCreate?: WeekDayCreateOrConnectWithoutAgendaInput
    connect?: WeekDayWhereUniqueInput
  }

  export type HostCreateNestedOneWithoutAgendaInput = {
    create?: XOR<HostCreateWithoutAgendaInput, HostUncheckedCreateWithoutAgendaInput>
    connectOrCreate?: HostCreateOrConnectWithoutAgendaInput
    connect?: HostWhereUniqueInput
  }

  export type WeekDayUpdateOneRequiredWithoutAgendaNestedInput = {
    create?: XOR<WeekDayCreateWithoutAgendaInput, WeekDayUncheckedCreateWithoutAgendaInput>
    connectOrCreate?: WeekDayCreateOrConnectWithoutAgendaInput
    upsert?: WeekDayUpsertWithoutAgendaInput
    connect?: WeekDayWhereUniqueInput
    update?: XOR<WeekDayUpdateWithoutAgendaInput, WeekDayUncheckedUpdateWithoutAgendaInput>
  }

  export type HostUpdateOneWithoutAgendaNestedInput = {
    create?: XOR<HostCreateWithoutAgendaInput, HostUncheckedCreateWithoutAgendaInput>
    connectOrCreate?: HostCreateOrConnectWithoutAgendaInput
    upsert?: HostUpsertWithoutAgendaInput
    disconnect?: boolean
    delete?: boolean
    connect?: HostWhereUniqueInput
    update?: XOR<HostUpdateWithoutAgendaInput, HostUncheckedUpdateWithoutAgendaInput>
  }
  ...
  export type HostCreateNestedManyWithoutHostTypeInput = {
    create?: XOR<Enumerable<HostCreateWithoutHostTypeInput>, Enumerable<HostUncheckedCreateWithoutHostTypeInput>>
    connectOrCreate?: Enumerable<HostCreateOrConnectWithoutHostTypeInput>
    createMany?: HostCreateManyHostTypeInputEnvelope
    connect?: Enumerable<HostWhereUniqueInput>
  }

  export type HostUncheckedCreateNestedManyWithoutHostTypeInput = {
    create?: XOR<Enumerable<HostCreateWithoutHostTypeInput>, Enumerable<HostUncheckedCreateWithoutHostTypeInput>>
    connectOrCreate?: Enumerable<HostCreateOrConnectWithoutHostTypeInput>
    createMany?: HostCreateManyHostTypeInputEnvelope
    connect?: Enumerable<HostWhereUniqueInput>
  ...
  export type HostUpdateManyWithoutHostTypeNestedInput = {
    create?: XOR<Enumerable<HostCreateWithoutHostTypeInput>, Enumerable<HostUncheckedCreateWithoutHostTypeInput>>
    connectOrCreate?: Enumerable<HostCreateOrConnectWithoutHostTypeInput>
    upsert?: Enumerable<HostUpsertWithWhereUniqueWithoutHostTypeInput>
    createMany?: HostCreateManyHostTypeInputEnvelope
    set?: Enumerable<HostWhereUniqueInput>
    disconnect?: Enumerable<HostWhereUniqueInput>
    delete?: Enumerable<HostWhereUniqueInput>
    connect?: Enumerable<HostWhereUniqueInput>
    update?: Enumerable<HostUpdateWithWhereUniqueWithoutHostTypeInput>
    updateMany?: Enumerable<HostUpdateManyWithWhereWithoutHostTypeInput>
    deleteMany?: Enumerable<HostScalarWhereInput>
  }

  export type HostUncheckedUpdateManyWithoutHostTypeNestedInput = {
    create?: XOR<Enumerable<HostCreateWithoutHostTypeInput>, Enumerable<HostUncheckedCreateWithoutHostTypeInput>>
    connectOrCreate?: Enumerable<HostCreateOrConnectWithoutHostTypeInput>
    upsert?: Enumerable<HostUpsertWithWhereUniqueWithoutHostTypeInput>
    createMany?: HostCreateManyHostTypeInputEnvelope
  ...
  export type HostAgendaCreateWithoutHostInput = {
    id?: number
    weekday: WeekDayCreateNestedOneWithoutAgendaInput
    open: string
  }

  export type HostAgendaUncheckedCreateWithoutHostInput = {
    id?: number
    dayId: number
    open: string
  }

  export type HostAgendaCreateOrConnectWithoutHostInput = {
    where: HostAgendaWhereUniqueInput
    create: XOR<HostAgendaCreateWithoutHostInput, HostAgendaUncheckedCreateWithoutHostInput>
  }

  export type HostAgendaCreateManyHostInputEnvelope = {
    data: Enumerable<HostAgendaCreateManyHostInput>
    skipDuplicates?: boolean
  }

  export type HostTypeCreateWithoutHostInput = {
    type: string
  }

  export type HostTypeUncheckedCreateWithoutHostInput = {
    id?: number
    type: string
  }

  export type HostTypeCreateOrConnectWithoutHostInput = {
    where: HostTypeWhereUniqueInput
    create: XOR<HostTypeCreateWithoutHostInput, HostTypeUncheckedCreateWithoutHostInput>
  }
  ...
  export type HostAgendaUpsertWithWhereUniqueWithoutHostInput = {
    where: HostAgendaWhereUniqueInput
    update: XOR<HostAgendaUpdateWithoutHostInput, HostAgendaUncheckedUpdateWithoutHostInput>
    create: XOR<HostAgendaCreateWithoutHostInput, HostAgendaUncheckedCreateWithoutHostInput>
  }

  export type HostAgendaUpdateWithWhereUniqueWithoutHostInput = {
    where: HostAgendaWhereUniqueInput
    data: XOR<HostAgendaUpdateWithoutHostInput, HostAgendaUncheckedUpdateWithoutHostInput>
  }

  export type HostAgendaUpdateManyWithWhereWithoutHostInput = {
    where: HostAgendaScalarWhereInput
    data: XOR<HostAgendaUpdateManyMutationInput, HostAgendaUncheckedUpdateManyWithoutAgendaInput>
  }

  export type HostAgendaScalarWhereInput = {
    AND?: Enumerable<HostAgendaScalarWhereInput>
    OR?: Enumerable<HostAgendaScalarWhereInput>
    NOT?: Enumerable<HostAgendaScalarWhereInput>
    id?: IntFilter | number
    dayId?: IntFilter | number
    open?: StringFilter | string
    hostId?: IntFilter | number
  ...
  export type HostTypeUpsertWithoutHostInput = {
    update: XOR<HostTypeUpdateWithoutHostInput, HostTypeUncheckedUpdateWithoutHostInput>
    create: XOR<HostTypeCreateWithoutHostInput, HostTypeUncheckedCreateWithoutHostInput>
  }

  export type HostTypeUpdateWithoutHostInput = {
    type?: StringFieldUpdateOperationsInput | string
  }

  export type HostTypeUncheckedUpdateWithoutHostInput = {
    id?: IntFieldUpdateOperationsInput | number
    type?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type EventStateCreateWithoutEventInput = {
    id: number
    status: string
  }

  export type EventStateUncheckedCreateWithoutEventInput = {
    id: number
    status: string
  }

  export type EventStateCreateOrConnectWithoutEventInput = {
    where: EventStateWhereUniqueInput
    create: XOR<EventStateCreateWithoutEventInput, EventStateUncheckedCreateWithoutEventInput>
  }
  ...
  export type EventStateUpsertWithoutEventInput = {
    update: XOR<EventStateUpdateWithoutEventInput, EventStateUncheckedUpdateWithoutEventInput>
    create: XOR<EventStateCreateWithoutEventInput, EventStateUncheckedCreateWithoutEventInput>
  }

  export type EventStateUpdateWithoutEventInput = {
    id?: IntFieldUpdateOperationsInput | number
    status?: StringFieldUpdateOperationsInput | string
  }

  export type EventStateUncheckedUpdateWithoutEventInput = {
    id?: IntFieldUpdateOperationsInput | number
    status?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type EventCreateOrConnectWithoutStateInput = {
    where: EventWhereUniqueInput
    create: XOR<EventCreateWithoutStateInput, EventUncheckedCreateWithoutStateInput>
  }

  export type EventCreateManyStateInputEnvelope = {
    data: Enumerable<EventCreateManyStateInput>
    skipDuplicates?: boolean
  }

  export type EventUpsertWithWhereUniqueWithoutStateInput = {
    where: EventWhereUniqueInput
    update: XOR<EventUpdateWithoutStateInput, EventUncheckedUpdateWithoutStateInput>
    create: XOR<EventCreateWithoutStateInput, EventUncheckedCreateWithoutStateInput>
  }

  export type EventUpdateWithWhereUniqueWithoutStateInput = {
    where: EventWhereUniqueInput
    data: XOR<EventUpdateWithoutStateInput, EventUncheckedUpdateWithoutStateInput>
  }
  ...
  export type HostAgendaCreateWithoutWeekdayInput = {
    id?: number
    open: string
    host?: HostCreateNestedOneWithoutAgendaInput
  }

  export type HostAgendaUncheckedCreateWithoutWeekdayInput = {
    id?: number
    open: string
    hostId: number
  }

  export type HostAgendaCreateOrConnectWithoutWeekdayInput = {
    where: HostAgendaWhereUniqueInput
    create: XOR<HostAgendaCreateWithoutWeekdayInput, HostAgendaUncheckedCreateWithoutWeekdayInput>
  }

  export type HostAgendaCreateManyWeekdayInputEnvelope = {
    data: Enumerable<HostAgendaCreateManyWeekdayInput>
    skipDuplicates?: boolean
  }

  export type HostAgendaUpsertWithWhereUniqueWithoutWeekdayInput = {
    where: HostAgendaWhereUniqueInput
    update: XOR<HostAgendaUpdateWithoutWeekdayInput, HostAgendaUncheckedUpdateWithoutWeekdayInput>
    create: XOR<HostAgendaCreateWithoutWeekdayInput, HostAgendaUncheckedCreateWithoutWeekdayInput>
  }

  export type HostAgendaUpdateWithWhereUniqueWithoutWeekdayInput = {
    where: HostAgendaWhereUniqueInput
    data: XOR<HostAgendaUpdateWithoutWeekdayInput, HostAgendaUncheckedUpdateWithoutWeekdayInput>
  }

  export type HostAgendaUpdateManyWithWhereWithoutWeekdayInput = {
    where: HostAgendaScalarWhereInput
    data: XOR<HostAgendaUpdateManyMutationInput, HostAgendaUncheckedUpdateManyWithoutAgendaInput>
  }

  export type WeekDayCreateWithoutAgendaInput = {
    id: number
    day: string
  }

  export type WeekDayUncheckedCreateWithoutAgendaInput = {
    id: number
    day: string
  }

  export type WeekDayCreateOrConnectWithoutAgendaInput = {
    where: WeekDayWhereUniqueInput
    create: XOR<WeekDayCreateWithoutAgendaInput, WeekDayUncheckedCreateWithoutAgendaInput>
  }

  export type HostCreateWithoutAgendaInput = {
    hostName: string
    password: string
    address?: hostAddressCreateNestedManyWithoutHostInput
    contact?: hostContactCreateNestedManyWithoutHostInput
  ...
  export type HostUncheckedCreateWithoutAgendaInput = {
    id?: number
    hostName: string
    password: string
    address?: hostAddressUncheckedCreateNestedManyWithoutHostInput
  ...
  export type HostCreateOrConnectWithoutAgendaInput = {
    where: HostWhereUniqueInput
    create: XOR<HostCreateWithoutAgendaInput, HostUncheckedCreateWithoutAgendaInput>
  }

  export type WeekDayUpsertWithoutAgendaInput = {
    update: XOR<WeekDayUpdateWithoutAgendaInput, WeekDayUncheckedUpdateWithoutAgendaInput>
    create: XOR<WeekDayCreateWithoutAgendaInput, WeekDayUncheckedCreateWithoutAgendaInput>
  }

  export type WeekDayUpdateWithoutAgendaInput = {
    id?: IntFieldUpdateOperationsInput | number
    day?: StringFieldUpdateOperationsInput | string
  }

  export type WeekDayUncheckedUpdateWithoutAgendaInput = {
    id?: IntFieldUpdateOperationsInput | number
    day?: StringFieldUpdateOperationsInput | string
  }

  export type HostUpsertWithoutAgendaInput = {
    update: XOR<HostUpdateWithoutAgendaInput, HostUncheckedUpdateWithoutAgendaInput>
    create: XOR<HostCreateWithoutAgendaInput, HostUncheckedCreateWithoutAgendaInput>
  }

  export type HostUpdateWithoutAgendaInput = {
    hostName?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    address?: hostAddressUpdateManyWithoutHostNestedInput
    contact?: hostContactUpdateManyWithoutHostNestedInput
  ...
  export type HostUncheckedUpdateWithoutAgendaInput = {
    id?: IntFieldUpdateOperationsInput | number
    hostName?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    address?: hostAddressUncheckedUpdateManyWithoutHostNestedInput
  ...
  export type HostCreateWithoutHostTypeInput = {
    hostName: string
    password: string
    address?: hostAddressCreateNestedManyWithoutHostInput
    contact?: hostContactCreateNestedManyWithoutHostInput
  ...
  export type HostUncheckedCreateWithoutHostTypeInput = {
    id?: number
    hostName: string
    password: string
    address?: hostAddressUncheckedCreateNestedManyWithoutHostInput
  ...
  export type HostCreateOrConnectWithoutHostTypeInput = {
    where: HostWhereUniqueInput
    create: XOR<HostCreateWithoutHostTypeInput, HostUncheckedCreateWithoutHostTypeInput>
  }

  export type HostCreateManyHostTypeInputEnvelope = {
    data: Enumerable<HostCreateManyHostTypeInput>
    skipDuplicates?: boolean
  }

  export type HostUpsertWithWhereUniqueWithoutHostTypeInput = {
    where: HostWhereUniqueInput
    update: XOR<HostUpdateWithoutHostTypeInput, HostUncheckedUpdateWithoutHostTypeInput>
    create: XOR<HostCreateWithoutHostTypeInput, HostUncheckedCreateWithoutHostTypeInput>
  }

  export type HostUpdateWithWhereUniqueWithoutHostTypeInput = {
    where: HostWhereUniqueInput
    data: XOR<HostUpdateWithoutHostTypeInput, HostUncheckedUpdateWithoutHostTypeInput>
  }

  export type HostUpdateManyWithWhereWithoutHostTypeInput = {
    where: HostScalarWhereInput
    data: XOR<HostUpdateManyMutationInput, HostUncheckedUpdateManyWithoutHostInput>
  }
  ...
  export type HostAgendaCreateManyHostInput = {
    id?: number
    dayId: number
    open: string
  }
  ...
  export type HostAgendaUpdateWithoutHostInput = {
    id?: IntFieldUpdateOperationsInput | number
    weekday?: WeekDayUpdateOneRequiredWithoutAgendaNestedInput
    open?: StringFieldUpdateOperationsInput | string
  }

  export type HostAgendaUncheckedUpdateWithoutHostInput = {
    id?: IntFieldUpdateOperationsInput | number
    dayId?: IntFieldUpdateOperationsInput | number
    open?: StringFieldUpdateOperationsInput | string
  }

  export type HostAgendaUncheckedUpdateManyWithoutAgendaInput = {
    id?: IntFieldUpdateOperationsInput | number
    dayId?: IntFieldUpdateOperationsInput | number
    open?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type HostAgendaCreateManyWeekdayInput = {
    id?: number
    open: string
    hostId: number
  }

  export type HostAgendaUpdateWithoutWeekdayInput = {
    id?: IntFieldUpdateOperationsInput | number
    open?: StringFieldUpdateOperationsInput | string
    host?: HostUpdateOneWithoutAgendaNestedInput
  }

  export type HostAgendaUncheckedUpdateWithoutWeekdayInput = {
    id?: IntFieldUpdateOperationsInput | number
    open?: StringFieldUpdateOperationsInput | string
    hostId?: IntFieldUpdateOperationsInput | number
  }
  ...
  export type HostCreateManyHostTypeInput = {
    id?: number
    hostName: string
    password: string
  }

  export type HostUpdateWithoutHostTypeInput = {
    hostName?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    address?: hostAddressUpdateManyWithoutHostNestedInput
    contact?: hostContactUpdateManyWithoutHostNestedInput
  ...
  export type HostUncheckedUpdateWithoutHostTypeInput = {
    id?: IntFieldUpdateOperationsInput | number
    hostName?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
    address?: hostAddressUncheckedUpdateManyWithoutHostNestedInput
  ...
  export type HostUncheckedUpdateManyWithoutHostInput = {
    id?: IntFieldUpdateOperationsInput | number
    hostName?: StringFieldUpdateOperationsInput | string
    password?: StringFieldUpdateOperationsInput | string
  }
